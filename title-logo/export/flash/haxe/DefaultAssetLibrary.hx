...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/Ubuntu-M.ttf", __ASSET__assets_ubuntu_m_ttf);
		type.set ("assets/Ubuntu-M.ttf", AssetType.FONT);
		...
		id = "assets/Ubuntu-M.ttf";
		className.set (id, __ASSET__assets_ubuntu_m_ttf);
...
@:keep @:bind #if display private #end class __ASSET__assets_logo_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
